  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quote:
        "الشركة دي فعلاً غيرت تجربة عملي بالكامل! تصميم الويب كان سلس وجذاب، والفريق كان متعاون جدًا في تعديل كل التفاصيل حسب احتياجاتي.",
      rating: 5,
    ...
    },
    {
      ...
      role: "مديرة التسويق",
      quote:
        "اشتغلنا مع الفريق على تطبيق الموبايل لشركتنا، وكانت تجربة التعاون ممتازة. الواجهة سهلة الاستخدام والـ UI/UX رائعة، فعلاً محترفين!",
      rating: 5,
    ...
    },
    {
      ...
      quote:
        "تعاملهم مع السوشيال ميديا ساعدنا نكبر التفاعل بنسبة كبيرة. المحتوى كان جذاب واستراتيجيته واضحة، وفريق الدعم متجاوب على طول.",
      rating: 5,
    ...
    },
    {
      ...
      role: "رائد أعمال",
      quote:
        "خدماتهم في الـ UI/UX خلت التطبيق بتاعي سلس وسهل الاستخدام، وزودت نسبة الاحتفاظ بالمستخدمين. أنصح أي حد بجد يجرب خدماتهم.",
      rating: 5,
